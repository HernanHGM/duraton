...
### Revisar
def download_and_save_weather_data(location_list, start_date_dt, start_date):
...
# %% 4. DESCARGA DATOS
# download_and_save_weather_data(location_list, start_date_dt, start_date)

# %% 5. CARGAMOS y TRANFORMAMOS DATOS
weather_data = load_json_and_transformorm_to_dataframe(location_list)
# %% 6. GUARDAMOS DATOS
save_weather_dataframe(weather_data)

# %% 7. CARGAMOS DATOS COMPLETOS (CSV)
weather_dict = load_weather_dataframe()
